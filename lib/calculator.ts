...
export const VEHICLES: Vehicle[] = [
  {
    ...
    battery: 60.0,
    baseWh: 157,
    physics: { mass: 1921, cd: 0.22, frontalArea: 2.70, crr: 0.009, drivetrainEff: 0.91, regenEff: 0.65, hasHeatPump: true },
  },
  {
    ...
    battery: 79.0,
    baseWh: 153,
    physics: { mass: 1992, cd: 0.22, frontalArea: 2.70, crr: 0.009, drivetrainEff: 0.91, regenEff: 0.65, hasHeatPump: true },
  },
  {
    id: 'tesla-my-juniper-perf',
    name: 'Tesla Model Y Juniper Performance',
    battery: 79.0,
    baseWh: 162,
    physics: { mass: 2033, cd: 0.22, frontalArea: 2.70, crr: 0.010, drivetrainEff: 0.91, regenEff: 0.65, hasHeatPump: true },
  },
  {
    id: 'tesla-my-legacy-lr',
    name: 'Tesla Model Y Legacy LR',
    battery: 75.0,
    baseWh: 169,
  ...
  },
  {
    ...
    battery: 50.0,
    baseWh: 139,
    physics: { mass: 1775, cd: 0.21, frontalArea: 2.36, crr: 0.009, drivetrainEff: 0.92, regenEff: 0.65, hasHeatPump: true },
  },
  {
    id: 'ioniq5-sr',
    name: 'Hyundai Ioniq 5 SR',
    battery: 54.0,
    baseWh: 167,
  ...
  },
  {
    ...
    battery: 85.0,
    baseWh: 125,
    physics: { mass: 2055, cd: 0.21, frontalArea: 2.29, crr: 0.009, drivetrainEff: 0.92, regenEff: 0.65, hasHeatPump: true },
  },
  {
    id: 'mercedes-glb-250',
    ...
    battery: 85.0,
    baseWh: 164,
    physics: { mass: 2270, cd: 0.28, frontalArea: 2.64, crr: 0.009, drivetrainEff: 0.90, regenEff: 0.65, hasHeatPump: true },
  },
  {
    id: 'bmw-ix3-nk',
    name: 'BMW iX3 Neue Klasse',
    battery: 108.7,
    baseWh: 151,
    physics: { mass: 2285, cd: 0.24, frontalArea: 2.60, crr: 0.009, drivetrainEff: 0.91, regenEff: 0.65, hasHeatPump: true },
  },
  {
    id: 'togg-t10x-lr',
  ...
  },
  {
    ...
    battery: 85.0,
    baseWh: 169,
    physics: { mass: 2000, cd: 0.226, frontalArea: 2.31, crr: 0.009, drivetrainEff: 0.90, regenEff: 0.65, hasHeatPump: true },
  },
  {
    id: 'byd-seal-u',
    name: 'BYD Seal U EV',
    battery: 87.0,
    baseWh: 205,
    physics: { mass: 2147, cd: 0.32, frontalArea: 2.65, crr: 0.010, drivetrainEff: 0.88, regenEff: 0.60, hasHeatPump: true },
  },
  {
    id: 'renault-megane',
    ...
    battery: 60.0,
    baseWh: 151,
    physics: { mass: 1708, cd: 0.29, frontalArea: 2.35, crr: 0.009, drivetrainEff: 0.91, regenEff: 0.65, hasHeatPump: true },
  },
]
